...
!function () {
    ...
    pluginManager.add("windowpreview", (editor) => {
        ...
        editor.addCommand("mceWindowPreview", () => {
            toggleNewWindowPreview(editor, stateContainer);
        });
        editor.ui.registry.addToggleMenuItem("windowpreview", {
            text: "新窗口预览",
            onAction: () => editor.execCommand("mceWindowPreview"),
